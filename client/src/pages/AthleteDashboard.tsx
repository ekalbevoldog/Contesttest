...
export default function AthleteDashboard() {
  ...
  useEffect(() => {
    ...
    if (authProfile && user?.role === 'athlete') {
      console.log('Using profile data from auth context');
      
      const profileToUse: ProfileData = {
        id: String(authProfile.id || ''),
        name: authProfile.name || '',
        sport: authProfile.sport || '',
        school: authProfile.school || '',
        email: authProfile.email || user.email || '',
        phone: authProfile.phone || '',
        socialMedia: {
          instagram: authProfile.social_handles?.instagram || 
                    authProfile.socialHandles?.instagram || '',
          twitter: authProfile.social_handles?.twitter || 
                  authProfile.socialHandles?.twitter || '',
          tiktok: authProfile.social_handles?.tiktok || 
                 authProfile.socialHandles?.tiktok || ''
        }
      };
    ...
    if (user?.id) {
      console.log(`Using userId ${user.id} to fetch athlete profile`);
      
      fetch(`/api/supabase/athlete-profile/${user.id}`)
        .then(res => {
          if (!res.ok) {
        ...
        .then(data => {
          ...
          if (data?.profile) {
            const profile: ProfileData = {
              ...
              socialMedia: {
                instagram: data.profile.social_handles?.instagram || ''
              }
            };
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-blue-700 mt-1">{notification.time}</div>
                          </div>
                        </div>
                      </div>
                    ))}
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-blue-700 mt-1">{message.time}</div>
                          </div>
                        </div>
                      </div>
                    ))}
                ...
                <div className="space-y-4">
                  {partnershipOffers.length > 0 ? (
                        ...
                        <CardContent className="pb-2">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                            <div className="flex flex-col gap-1">
                              <span className="text-sm text-blue-700">Offer Amount</span>
                              <span className="font-semibold">${offer.offerAmount}</span>
                            </div>
                            <div className="flex flex-col gap-1">
                              <span className="text-sm text-blue-700">Response Deadline</span>
                              <span className="font-semibold">{new Date(offer.deadline).toLocaleDateString()}</span>
                            </div>
                            <div className="flex flex-col gap-1">
                              <span className="text-sm text-blue-700">Deliverables</span>
                              <span className="font-semibold">{offer.deliverables.length} Items</span>
                            </div>
                          </div>
                          <div className="mt-2">
                            <span className="text-sm text-blue-700 block mb-1">Required Deliverables:</span>
                    ...
                    <div className="text-center py-10">
                      <div className="text-blue-700 mb-2">No partnership offers available</div>
              ...
              <CardContent>
                <div className="space-y-6">
                  {activePartnerships.length > 0 ? (
                    ...
                    <div className="text-center py-10">
                      <div className="text-blue-700 mb-2">No active partnerships</div>
                      <div className="text-sm text-blue-700 mb-4">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  {activePartnerships.flatMap(p => p.deliverables).filter(d => d.status === "pending").length === 0 && (
                    <div className="text-center py-10">
                      <div className="text-blue-700 mb-2">No pending deliverables</div>
                      <div className="text-sm text-blue-700 mb-4">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  {activePartnerships.flatMap(p => p.deliverables).filter(d => d.status === "completed").length === 0 && (
                    <div className="text-center py-10">
                      <div className="text-blue-700 mb-2">No completed deliverables yet</div>
                      <div className="text-sm text-blue-700 mb-4">
              ...
              <CardContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Card className="bg-muted/50">
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-blue-700 font-medium">Followers</span>
                            <span className="font-medium">78.5K</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-blue-700 font-medium">Engagement Rate</span>
                            <span className="font-medium">6.2%</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-blue-700 font-medium">Avg. Reach per Post</span>
                    ...
                    <Card className="bg-muted/50">
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-blue-700 font-medium">Avg. Views per Video</span>
                    ...
                    <Card className="bg-muted/50">
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-blue-700 font-medium">Avg. Impressions</span>
                ...
                <div className="mt-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-4 bg-gray-50 rounded-md">
                      <div className="text-blue-700 font-medium text-sm">Top Performing</div>
                      <div className="mt-1 font-medium">Athletic Wear Co</div>
                      <div className="text-sm text-blue-700">87K impressions</div>
                    </div>
                    <div className="p-4 bg-gray-50 rounded-md">
                      <div className="text-blue-700 font-medium text-sm">Most Engaging</div>
                      <div className="mt-1 font-medium">Energy Drinks Co</div>
                      <div className="text-sm text-blue-700">9.2% engagement</div>
                    </div>
                    <div className="p-4 bg-gray-50 rounded-md">
                      <div className="text-blue-700 font-medium text-sm">Audience Growth</div>
                      <div className="mt-1 font-medium">+12.5K followers</div>
                      <div className="text-sm text-blue-700">Since first campaign</div>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="earnings" className="space-y-6">
            <Card className="border-primary/20">
              ...
              <CardContent>
                <div className="h-[300px] flex items-center justify-center bg-gray-50 rounded-md mb-6">
                  <BarChart3 className="h-16 w-16 text-gray-600" />
                  <span className="ml-2 text-blue-700 font-medium">Earnings chart for selected period</span>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <Card className="bg-muted/50">
                    <CardHeader className="pb-2">
                    ...
                    <CardContent>
                      ...
                      <p className="text-sm text-blue-700">From {earningsData.campaigns} campaigns</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-muted/50">
                    <CardHeader className="pb-2">
                    ...
                    <CardContent>
                      ...
                      <p className="text-sm text-blue-700">To be received</p>
                    </CardContent>
                  </Card>
                  <Card className="bg-muted/50">
                    <CardHeader className="pb-2">
                  ...
                  <Card className="bg-muted/50">
                    ...
                    <CardContent>
                      ...
                      <p className="text-sm text-blue-700">From previous period</p>
                    </CardContent>
                  </Card>
                </div>
              </CardContent>
                  ...
                  {[
                    ...
                    <div key={idx} className="flex items-center justify-between p-4 rounded-md bg-gray-50">
                      <div>
                        ...
                        <div className="text-sm text-blue-700">{transaction.campaign}</div>
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <div className="font-semibold">${transaction.amount}</div>
                          <div className="text-sm text-blue-700">{new Date(transaction.date).toLocaleDateString()}</div>
                        </div>
                        <Badge 
            ...
            <Card className="border-primary/20">
              ...
              <CardContent>
                <div className="space-y-4">
                    ...
                    <div key={partnership.id} className="flex items-center justify-between p-4 rounded-md bg-gray-50">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-blue-700">{partnership.campaign}</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                  ...
                  {activePartnerships.length === 0 && (
                    <div className="text-center py-10">
                      <div className="text-blue-700 mb-2">No contracts available</div>
                      <div className="text-sm text-blue-700 mb-4">
                    ...
                    <div key={idx} className="flex items-center justify-between p-4 rounded-md bg-gray-50">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-blue-700">Issued on: {new Date(doc.date).toLocaleDateString()}</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        <Button variant="outline" size="sm">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1 space-y-4">
                        <div>
                          <label className="text-sm font-medium text-blue-700">Sport</label>
                          <div className="mt-1 p-3 bg-gray-50 rounded-md">
                            {profileData?.sport || "Basketball"}
                          </div>
                        </div>
                        <div>
                          <label className="text-sm font-medium text-blue-700">School</label>
                          <div className="mt-1 p-3 bg-gray-50 rounded-md">
                  ...
                  {[
                    ...
                    <div key={idx} className="flex items-center justify-between p-3 rounded-md bg-gray-50">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                          <label className="text-sm text-blue-700">Push</label>
